...
function FriendsPage({ firstName, onClose }) {
    ...
    const fetchReceivedRequests = async () => {
        const token = localStorage.getItem('Token');
        try {
            const response = await fetch(`${apiUrl}/api/v1/friends/getallreqrec`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': 'Bearer ' + token,
    ...
    const handleUnfriendClick = async (friendId) => {
        const token = localStorage.getItem('Token');
        try {
            const response = await fetch(`${apiUrl}/api/v1/friends/unFriend`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': 'Bearer ' + token,
    ...
    const handleDeleteRequestClick = async (requestId) => {
        ...
        const id = requestId;
        try {
            const response = await fetch(`${apiUrl}/api/v1/friends/delreq`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': 'Bearer ' + token,
    ...
    const handleAcceptRequestClick = async (requestId) => {
        ...
        const id = requestId;
        try {
            const response = await fetch(`${apiUrl}/api/v1/friends/acceptreq`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': 'Bearer ' + token,
    ...
    const handleDeclineRequestClick = async (requestId) => {
        ...
        const id = requestId;
        try {
            const response = await fetch(`${apiUrl}/api/v1/friends/declinereq`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': 'Bearer ' + token,
