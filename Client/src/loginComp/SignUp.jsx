...
import CircularProgress from "@mui/material/CircularProgress"; // Import CircularProgress for preloader
...
function SignUpForm() {
    ...
    const handleOnSubmit = async (evt) => {
        ...
        try {
            const response = await fetch(`${apiUrl}/api/v1/auth/sendotp`, {
                method: "POST",
                headers: {
    ...
    return (
        <div className="form-container sign-up-container">
            <form onSubmit={handleOnSubmit}>
                ...
                {isLoading ? (
                    <CircularProgress size={24} /> // Show circular progress while loading
                ) : (
